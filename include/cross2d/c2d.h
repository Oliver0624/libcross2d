...
#define KEY_JOY_MENU1_DEFAULT   SDL_CONTROLLER_BUTTON_LEFTSTICK
#define KEY_JOY_MENU2_DEFAULT   SDL_CONTROLLER_BUTTON_RIGHTSTICK
...
#ifndef NO_KEYBOARD
#if defined(__SDL2__)
// SDL key.keysym.scancode                     // OLIVER my private favorate keyboard mapping
#define KEY_KB_UP_DEFAULT       SDL_SCANCODE_W // SDL_SCANCODE_UP
#define KEY_KB_DOWN_DEFAULT     SDL_SCANCODE_S // SDL_SCANCODE_DOWN
#define KEY_KB_LEFT_DEFAULT     SDL_SCANCODE_A // SDL_SCANCODE_LEFT
#define KEY_KB_RIGHT_DEFAULT    SDL_SCANCODE_D // SDL_SCANCODE_RIGHT
#define KEY_KB_A_DEFAULT        SDL_SCANCODE_L // SDL_SCANCODE_A
#define KEY_KB_B_DEFAULT        SDL_SCANCODE_K // SDL_SCANCODE_S
#define KEY_KB_X_DEFAULT        SDL_SCANCODE_I // SDL_SCANCODE_Q
#define KEY_KB_Y_DEFAULT        SDL_SCANCODE_J // SDL_SCANCODE_W
#define KEY_KB_LT_DEFAULT       SDL_SCANCODE_U // SDL_SCANCODE_E
#define KEY_KB_RT_DEFAULT       SDL_SCANCODE_O // SDL_SCANCODE_D
#define KEY_KB_LB_DEFAULT       SDL_SCANCODE_N // SDL_SCANCODE_R
#define KEY_KB_RB_DEFAULT       SDL_SCANCODE_M // SDL_SCANCODE_F
#define KEY_KB_LS_DEFAULT       SDL_SCANCODE_Q // SDL_SCANCODE_T
#define KEY_KB_RS_DEFAULT       SDL_SCANCODE_E // SDL_SCANCODE_G
#define KEY_KB_SELECT_DEFAULT   SDL_SCANCODE_G // SDL_SCANCODE_SPACE
#define KEY_KB_START_DEFAULT    SDL_SCANCODE_H // SDL_SCANCODE_RETURN
